              ...
              <WindowFrame title={`Project-${index + 1}.exe`}>
                <div className="group">
                  ...
                  <div className='my-4 flex flex-wrap gap-2'>
                    <Badge variant="outline" className='border-2'>React</Badge>
                    <Badge variant="outline" className='border-2'>Next.js</Badge>
                    <Badge variant="outline" className='border-2'>Tailwind CSS</Badge>
                  </div>
                  <Link
                    href="#"
                    className="inline-flex items-center font-bold group/link mt-2"
                  >
                    View Project
